...
dataSet[dataSetVersion].characterData = [
  ...
  { name: "Tokiko",
    tag: "tokiko_(touhou)", img: "Y4maOc8.png", opts: { series: ["book"], stage: [] } },
  {
    name: "Rei'sen (Manga)",
    img: "cWjCo2j.png",
    opts: { series: ["book"], stage: [] }
  ...
  { name: "Ellen",
    tag: "ellen", img: "3iNNL0c.png", opts: { series: ["PoDD"], stage: [] } },
  {
    name: "Kotohime",
    tag: "kotohime",
    img: "kRSGtpq.png",
  ...
  { name: "Mai",
    tag: "mai_(touhou)", img: "r6w7TX1.png", opts: { series: ["MS"], stage: ["st4"] } },
  {
    name: "Yumeko",
    tag: "yumeko",
    img: "PcPqkdO.png",
