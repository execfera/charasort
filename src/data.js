...
/**
 * Sorter options. Characters will be removed from the sorting array based on selected options, working down the array.
 * 
 * @type {{name: string, key: string, tooltip?: string, checked?: boolean, sub?: {name: string, tooltip?: string, checked?: string}[]}[]}
 */
const options = [
  {
  ...
  },
  {
    ...
    key: "pc98",
    tooltip:
      "Check this to include PC-98 characters with a Windows counterpart.",
    checked: false
  },
  {
